------------------------------------------------------------
--[300000088]--  _fce-_fceCargar proyecto (Py-01) - relacion 
------------------------------------------------------------
...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, punto_montaje, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'_fce-_fceCargar proyecto (Py-01) - relacion', --nombre
	NULL, --titulo
	NULL, --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_dependencias (proyecto, dep_id, objeto_consumidor, objeto_proveedor, identificador, parametros_a, parametros_b, parametros_c, inicializar, orden) VALUES (
	...
	'300000127', --dep_id
	'300000088', --objeto_consumidor
	'300000015', --objeto_proveedor
	'proyectos_inv_en_programas', --identificador
	NULL, --parametros_a
	NULL, --parametros_b
	NULL, --parametros_c
	NULL, --inicializar
...
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	NULL, --padre_clave
	'investigaciones', --hijo_proyecto
	'300000015', --hijo_objeto
	'proyectos_inv_en_programas', --hijo_id
	NULL, --hijo_clave
	NULL, --cascada
	'4'  --orden
);
